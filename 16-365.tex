...
\jmlrheading{17}{2016}{1-5}{7/16; Revised 7/16}{11/16}{Guillaume Lema\^itre, Fernando Nogueira,
...
\author{Guillaume Lema\^itre \email guillaume.lemaitre@inria.fr \\
  \addr{Parietal team, Inria, CEA, Universit\'e Paris-Saclay} \\
  \addr{1 Rue Honor\'e d'Estienne d'Orves, 91120 Palaiseau, France}
  \AND
...
A class \texttt{Pipeline} is inherited from \texttt{scikit-learn}
