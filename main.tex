...
\jmlrheading{7}{2016}{1-5}{7/16}{-}{Guillaume Lema\^itre, Fernando Nogueira, Dayvid V. R. Oliveira and Christos K. Aridas}

% Short headings should be running head and authors last names
\ShortHeadings{A python toolbox to tackle the curse of imbalanced datasets in machine learning}{Lema\^itre, Nogueira, Victor, and Aridas}
\firstpageno{1}
...
\author{Guillaume Lema\^itre \email g.lemaitre58@gmail.com \\ 
    ...
    \addr{Campus Montilivi, Edifici P4, 17071 Girona, Spain}
        ...
        \addr{University Campus, GR-26110 Patras, Greece}} 
\editor{-}
