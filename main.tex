...
(ii) \texttt{sample} performs the sampling and return the data with the desired balancing ratio;
and (iii) \texttt{fit\_sample} is equivalent of calling the function \texttt{fit} followed by the function \texttt{transform}.
